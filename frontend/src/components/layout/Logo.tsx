export const Logo = ({ compact = false }: { compact?: boolean }) => (
  <div className="flex items-center gap-1 text-primary-700" aria-label="Parikshya">
    ...
    {!compact ? <span className="text-3xl font-extrabold leading-none tracking-normal">Parikshya</span> : null}
  </div>
);
