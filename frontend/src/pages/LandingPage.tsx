...
export const LandingPage = () => {
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-indigo-200/40 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="absolute top-20 right-1/4 w-[400px] h-[400px] bg-purple-200/30 rounded-full blur-[100px] pointer-events-none -z-10" />

      {/* Header */}
      <header className="h-20 bg-white/70 backdrop-blur-md border-b border-slate-200/80 px-6 sm:px-12 flex items-center justify-between sticky top-0 z-40">
        ...
        <div className="flex items-center gap-4">
          <Link 
            to="/login/student" 
            className="text-xs font-bold text-slate-600 hover:text-indigo-600 transition duration-150"
          >
            Student Portal
          </Link>
      ...
      <main className="flex-1 flex flex-col items-center">
        ...
        <section className="max-w-[1140px] px-6 text-center pt-16 pb-12 sm:pt-24 sm:pb-16 flex flex-col items-center">
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-[10px] font-extrabold uppercase tracking-wider mb-6 animate-pulse">
            <Sparkles className="h-3 w-3" />
            Empowering Modern Classrooms
          </div>
          
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight max-w-4xl">
          ...
          <p className="mt-6 text-base sm:text-lg text-slate-500 max-w-2xl leading-relaxed font-medium">
            PrepRoute simplifies exam generation, secures student attempts with intelligent tab-switch detection, and compiles detailed scorecards.
          </p>
        </section>

        {/* Roles Section */}
        <section className="max-w-[1140px] w-full px-6 pb-20">
          <h2 className="text-xs font-extrabold text-slate-400 tracking-widest uppercase text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Student Card */}
            <article className="group bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm hover:shadow-xl hover:border-indigo-400 transition-all duration-300 flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-50 rounded-bl-full -z-10 group-hover:bg-indigo-100 transition-colors" />
              <div className="h-12 w-12 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 mb-6 group-hover:scale-110 transition-transform">
                <GraduationCap className="h-6 w-6" />
              </div>
              <h3 className="text-lg font-bold text-slate-800 mb-2">Student Portal</h3>
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Exams & Scorecards</p>
            ...
            {/* Teacher Card */}
            <article className="group bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm hover:shadow-xl hover:border-purple-400 transition-all duration-300 flex flex-col relative overflow-hidden">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2">Teacher Portal</h3>
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Question Pools & Filters</p>
              <p className="text-sm text-slate-500 leading-relaxed mb-8">
            ...
            {/* Admin Card */}
            <article className="group bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm hover:shadow-xl hover:border-slate-800 transition-all duration-300 flex flex-col relative overflow-hidden">
              ...
              <div className="h-12 w-12 rounded-xl bg-slate-50 flex items-center justify-center text-slate-700 mb-6 group-hover:scale-110 transition-transform">
                <ShieldCheck className="h-6 w-6" />
              </div>
              <h3 className="text-lg font-bold text-slate-800 mb-2">Administrator Portal</h3>
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Management & Proctoring</p>
              <p className="text-sm text-slate-500 leading-relaxed mb-8">
        ...
        {/* Features Grid */}
        <section className="bg-slate-900 text-white w-full py-20 flex justify-center">
      ...
      <footer className="border-t border-slate-200 bg-white py-8 text-center text-xs text-slate-400 font-semibold uppercase tracking-wider">
        © 2026 PrepRoute. All rights reserved.
      </footer>
    </div>
  );
};
